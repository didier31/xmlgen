...
public class ExpandInstruction extends ExpansionInstruction
{
	...
	public Vector<Cloneable> expandMySelf(TemplateIterator it)
	{
		...
		if (expansionContext.isExecuting())
		{
			trace("<Expand>");
			/**
			 * Replace template, schema and output parameters by variable value of
			 * same name
			 */
			...
			if (frameStack.containsKey(trace))
			{
			...
			/**
			 * Check but there is no additionnal data source resources So, pass
			 * false as parameter.
			 */
			...
			{
				/**
				 * Creates a copy of the frame context. It isolates upper stack from
				 * corruption
				 */
